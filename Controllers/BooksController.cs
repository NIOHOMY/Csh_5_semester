...
namespace WebApplication1.Controllers
{
    public class BooksController : Controller
    {
        ...
        {
            var libraryContext = _context.Books.Include(b => b.FirstAuthor).Include(b => b.Publisher);
        ...
        {
            ViewData["FirstAuthorId"] = new SelectList(_context.Authors, "AuthorId", "Name");
        ...
        public async Task<IActionResult> Create([Bind("BookId,Title,FirstAuthorId,YearOfPublication,Price,NumberOfExamples,PublisherId")] Book book)
        {
            ...
            ViewData["FirstAuthorId"] = new SelectList(_context.Authors, "AuthorId", "Name", book.FirstAuthorId);
